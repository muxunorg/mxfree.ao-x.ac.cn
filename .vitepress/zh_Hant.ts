...
export const zh_Hant = defineConfig({
    title: "慕讯公益加速器",
    label: '简体中文',
    lang: 'zh-TW',
...
function sidebarGuide(): DefaultTheme.SidebarItem[] {
    return [
        ...
        { text: '配置和 API 参考', base: '/zh/reference/', link: 'site-conf' }
    ]
}
    ...
    return [
        {
            text: '参考',
            items: [
                { text: '站点配置', link: 'site-conf' },
                { text: 'frontmatter 配置', link: 'frontmatter-conf' },
